...
object Lesson04_kafka_consumer {
  def main(args: Array[String]): Unit = {
    ...
    props.put(ConsumerConfig.AUTO_OFFSET_RESET_CONFIG, "earliest") // consumer组从误导有的时候从什么位置开始取消息： earliest从组的CURRENT-OFFSET开始，CURRENT-OFFSET初始值为0，latest从LOG-END-OFFSET开始
