...
object Lesson03_Collections {
  def main(args: Array[String]): Unit = {
    ...
    // Tuple
    val t2 = new Tuple2(11, "asdads") // 很像键值对. 但是Tuple可以一直到Tuple22，有22项, 只有22个是因为语言的设计者到这里就懒的加了.其实再多也用的不多了，设计结合工程实践
    ...
    val iterFlatMap = iterator.flatMap(_.split("\\s+")) // 这个flatMap算子是个iterator的精髓案例
